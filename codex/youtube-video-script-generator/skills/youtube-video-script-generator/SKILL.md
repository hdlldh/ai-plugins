...
- Confirm the short scripts are clearly related to the regular video and designed to draw viewers to it.- Confirm the regular video and short videos each include a strong title that is clear, curious, and benefit-driven.- Confirm the reviewer provides an explicit evaluation of whether the output meets the requirements.
